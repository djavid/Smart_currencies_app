...
object Config {
    ...
    var country_coins = arrayOf(Coin("USD", App.context.resources.getStringArray(R.array.country_currencies)[0]), Coin("EUR", App.context.resources.getStringArray(R.array.country_currencies)[1]), Coin("CAD", App.context.resources.getStringArray(R.array.country_currencies)[2]), Coin("CNY", App.context.resources.getStringArray(R.array.country_currencies)[3]), Coin("JPY", App.context.resources.getStringArray(R.array.country_currencies)[4]), Coin("PLN", App.context.resources.getStringArray(R.array.country_currencies)[5]), Coin("GBP", App.context.resources.getStringArray(R.array.country_currencies)[6]), Coin("RUB", App.context.resources.getStringArray(R.array.country_currencies)[7]), Coin("UAH", App.context.resources.getStringArray(R.array.country_currencies)[8]))
